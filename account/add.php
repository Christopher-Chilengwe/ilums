...
?> 
 ...
 <form class="form-horizontal span6" action="<?php echo WEB_ROOT; ?>user/controller.php?action=editprof" method="POST">
          ...
          <fieldset>
            <legend> Update User Account</legend>
              ...
              <input class="form-control input-sm" id="U_NAME" name="U_NAME" placeholder=
                            "Account Name" type="text" value="<?php echo $singleuser->ACCOUNT_NAME; ?>" readonly>
              <?php }else{ ?>
                <input class="form-control input-sm" id="U_NAME" name="U_NAME" placeholder=
                      ...
                      <div class="col-md-8">
                        <input name="deptid" type="hidden" value="">
                         <input class="form-control input-sm" id="U_USERNAME" name="U_USERNAME" placeholder=
                            "Email Address" type="text" value="<?php echo $singleuser->ACCOUNT_USERNAME; ?>" readonly>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                         ...
                         <input class="form-control input-sm" id="U_ROLE" name="U_ROLE" placeholder=
                            "Email Address" type="text" value="<?php echo $singleuser->ACCOUNT_TYPE; ?>" readonly>
