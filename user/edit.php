                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                       <select class="form-control input-sm" name="U_ROLE" id="U_ROLE">
                        <option value="Administrator"  <?php echo ($singleuser->ACCOUNT_TYPE=='Administrator') ? 'selected="true"': '' ; ?>>Facilitator</option>
                        <option value="Librarian" <?php echo ($singleuser->ACCOUNT_TYPE=='Librarian') ? 'selected="true"': '' ; ?>>Librarian</option>
                         <option value="Librarian" <?php echo ($singleuser->ACCOUNT_TYPE=='Student') ? 'selected="true"': '' ; ?>>Student</option>
