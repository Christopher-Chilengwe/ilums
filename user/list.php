				  	...
				  	<?php 
						...
						foreach ($cur as $result) {
				  		...
				  		if ($result->ACC_STATUS == 'ACTIVE' ){
							echo '<a title="Deactivate" href="controller.php?action=delete&id='.$result->ACCOUNT_ID.'" class="btn btn-success btn-xs deactivate" '.$active.'><span class="fa fa-info fw-fa"></span> </a>';	  				
				  		}else{
				  			echo '<a title="Activate" href="controller.php?action=delete1&id='.$result->ACCOUNT_ID.'" class="btn btn-danger btn-xs useractive" '.$active.'><span class="fa fa-info fw-fa"></span> </a>';	
				  		}		
				  		echo '	 </td>';
				  		echo '</tr>';
				  	} 
