...
$student = new Student();
$cur = $student->single_student($_SESSION['EMPID']);

?> 

 <form class="form-horizontal well span6" action="<?php echo WEB_ROOT; ?>student/controller.php?action=doEditProfile" method="POST">
