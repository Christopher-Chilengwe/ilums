        	...
        	<!-- /.col-lg-12 -->
				...
				<table id="dash-table" class="table table-striped table-bordered table-hover table-responsive" style="font-size:12px" cellspacing="0">
				  ...
				  <tbody>
				  	<?php 
				  	global $mydb;
				  		$mydb->setQuery("select  * from tbldefaulttime");
						$cur = $mydb->loadResultList();
						foreach ($cur as $Defaults) {
				  		echo '<tr>';

				  		echo '<td>' . $Defaults->ALLOTEDTIME.'</a></td>';
				 		echo '<td>'. $Defaults->ISDEFAULT.'</td>';
				  		echo $active = "";
				  		
				  		echo '<td align="center" > <a title="Edit" href="index.php?view=edit&id='.$Defaults->TIMEID.'"  class="btn btn-primary btn-xs  ">  <span class="fa fa-edit fw-fa"></span></a>';
				  			?>		 
